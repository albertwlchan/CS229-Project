...
def get_data2(): ### Creates Image Masks for RCNN
    ...
    #Load Labels
    labeled_data = pd.read_csv("E163L02A/E163L02A_labels.csv",header=1)
    ...
    test_dataset = tf.data.Dataset.zip((inputs,mask_labels)).batch(32)
    ...
    return train_dataset,test_dataset,inputs, diameter_ground_truth