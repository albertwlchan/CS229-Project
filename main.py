...
def main():
    ...
    train_data,test_data,images = get_data2()
    ...
    if not os.path.exists(path_model) or Train == True:
        ...
        # Loads Save Model
        model = tf.keras.models.load_model(path_model,custom_objects={'loss': tf.keras.losses.BinaryCategoricalCrossentropy(from_logits=True)})
